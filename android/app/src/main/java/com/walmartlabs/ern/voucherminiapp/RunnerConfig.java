package com.walmartlabs.ern.voucherminiapp;

import com.walmartlabs.ern.container.miniapps.VoucherMiniappActivity;
...
final class RunnerConfig {
    static final Class MAIN_MINIAPP_ACTIVITY_CLASS = VoucherMiniappActivity.class;
